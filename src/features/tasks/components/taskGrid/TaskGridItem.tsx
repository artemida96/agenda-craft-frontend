...
const TaskGridItem = ({taskItem, index}: TaskGridItemType) =>{
    ...
    return <div className={index===0? "mt-4 p-4  w-64 h-64 flex flex-col gap-2   bg-primary rounded-lg drop-shadow-xl":"mt-4 p-4 w-64 h-64 flex flex-col gap-2 bg-white rounded-lg drop-shadow-xl"}>
